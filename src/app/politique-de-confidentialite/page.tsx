	...
	return (
		<div className="bg-support text-univers min-h-full">
			...
			<TitlePage
				...
				paddingBottom={false}
			/>
			<section className="mx-auto max-w-4xl px-5 pb-8 sm:px-6 lg:px-8">
				<div className="border border-univers w-12 my-8"></div>
				<p className="text-sm text-univers/70">
			...
			<nav
				aria-label="Sommaire"
				className="mx-auto max-w-4xl px-5 pb-6 sm:px-6 lg:px-8"
			>
				<div className="rounded-2xl border border-univers/20 bg-white/50 p-4 sm:p-6">
					...
					<ul className="mt-3 grid gap-3 sm:grid-cols-2 text-sm">
						{[
							...
							<li key={href}>
								<a
									className="text-univers hover:text-cohesion hover:underline hover:underline-offset-4 transition-colors"
									href={href}
								>
									{label}
								</a>
			...
			{/* Content */}
			<article className="mx-auto max-w-4xl px-5 pb-20 space-y-8 sm:px-6 lg:px-8">
				{/* Intro */}
				<section className="bg-white/30 rounded-2xl p-6">
					<div className="text-base leading-relaxed space-y-3">
						<p>
							...
							<strong>IPSEIS</strong> (ci-après &laquo;&nbsp;nous&nbsp;&raquo;)
						...
						<p>
							Elle est rédigée conformément au Règlement Général sur la
							Protection des Données (RGPD &ndash; Règlement UE 2016/679) et à
				...
				<section
					id="responsable"
					className="scroll-mt-24 bg-white/30 rounded-2xl p-6"
				>
					<h2 className="text-xl font-bold text-cohesion mb-4">
					...
					<div className="text-base leading-relaxed space-y-2">
						...
						<ul className="list-none space-y-1 text-univers/90">
							<li>
								<strong>IPSEIS</strong> &mdash; SARL au capital social, SIREN
								931 671 606 R.C.S. Saint-Malo
							</li>
							<li>Siège social : 21 Rue de la Nation, 35400 Saint-Malo</li>
							<li>
								Représentante légale :{" "}
								<em className="text-univers/70">Hélène PAILLOT DE MONTABERT</em>
							</li>
							<li>
								Email de contact :{" "}
								<a
				...
				>
					...
					<div className="text-base leading-relaxed space-y-4">
						...
						<div>
							<h3 className="text-lg font-semibold text-maitrise mb-2">
								2.1. Formulaire de contact
							</h3>
							<p className="text-univers/90">
								Nom, prénom, email, téléphone, organisme, fonction, objet et
								contenu du message.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-univers/90">
								Nom, prénom, email, téléphone, organisme, poste, adresse, mot de
								passe (chiffré), rôle, historique de connexion.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-univers/90">
								Adresse IP (anonymisée lorsque possible), type de navigateur,
								pages visitées, durée de visite, données de performance (Vercel
							...
							<table className="w-full text-sm border-collapse">
								<thead>
									<tr className="border-b border-univers/20">
										<th className="text-left py-3 pr-4 font-semibold text-maitrise">
											Finalité
										</th>
										<th className="text-left py-3 font-semibold text-maitrise">
											Base légale
										</th>
									</tr>
								</thead>
								<tbody className="text-univers/90">
									...
									<tr className="border-b border-univers/10">
										<td className="py-3 pr-4">
											Envoi du catalogue de formations
										</td>
										<td className="py-3">Consentement</td>
									</tr>
									<tr className="border-b border-univers/10">
										<td className="py-3 pr-4">
											Gestion de l&apos;Espace Personnel (authentification,
											contrats, ressources, messagerie)
										</td>
										<td className="py-3">Exécution contractuelle</td>
									</tr>
									<tr className="border-b border-univers/10">
										<td className="py-3 pr-4">
											Prospection B2B et communication institutionnelle
										</td>
										<td className="py-3">
											Intérêt légitime (avec droit d&apos;opposition)
										</td>
									</tr>
									<tr>
										<td className="py-3 pr-4">
				...
				>
					...
					<div className="text-base leading-relaxed space-y-3">
						...
						<ul className="list-disc list-inside space-y-2 text-univers/90">
							<li>
								<strong>L&apos;équipe IPSEIS</strong> : pour le traitement de
								vos demandes et la gestion de votre Espace Personnel.
							</li>
							<li>
								<strong>Vercel Inc</strong> (hébergement du site web) : 440 N
								Barranca Avenue #4133, Covina, CA 91723, États-Unis.
							</li>
							<li>
								<strong>OVHcloud</strong> (hébergement du serveur applicatif et
								de la base de données) : 2 rue Kellermann, 59100 Roubaix,
								France.
							</li>
							<li>
								<strong>Google (Gmail SMTP)</strong> : pour l&apos;envoi
								d&apos;emails transactionnels (réinitialisation de mot de passe,
								notifications).
							</li>
						</ul>
						<p>
							Ces prestataires agissent en qualité de sous-traitants au sens de
							l&apos;article 28 du RGPD, avec des garanties contractuelles
							adéquates.
						</p>
					</div>
				</section>
				...
				>
					...
					<div className="text-base leading-relaxed">
						<ul className="list-disc list-inside space-y-2 text-univers/90">
							...
							<li>
								<strong>Téléchargement du catalogue (prospects)</strong> : 3 ans
								à compter du dernier contact.
							</li>
							<li>
								<strong>Comptes utilisateurs (Espace Personnel)</strong> : durée
								de la relation contractuelle, puis 3 ans à compter de la
								dernière activité.
							</li>
							<li>
								<strong>Contrats et documents administratifs</strong> : durée
								légale applicable (5 à 10 ans selon obligation).
							</li>
							<li>
				...
				>
					...
					<div className="text-base leading-relaxed space-y-4">
							...
							<table className="w-full text-sm border-collapse">
								...
								<tbody className="text-univers/90">
									<tr className="border-b border-univers/10">
										...
										<td className="py-3 pr-4">
											Authentification de l&apos;Espace Personnel
										</td>
									...
									<tr>
										...
										<td className="py-3 pr-4">
											Analytics et performance (Vercel)
										</td>
						...
						<p>
							Les cookies essentiels sont exemptés de consentement car
							strictement nécessaires au fonctionnement du service. Vous pouvez
							à tout moment gérer vos préférences via les paramètres de votre
							navigateur.
						</p>
					</div>
				</section>
				...
				>
					...
					<div className="text-base leading-relaxed space-y-3">
						<p>
							Conformément au RGPD (articles 15 à 22) et à la loi Informatique
						...
						<ul className="list-disc list-inside space-y-2 text-univers/90">
							...
							<li>
								...
								traitement pour motifs légitimes, y compris la prospection.
							</li>
							<li>
							...
							<li>
								...
								organiser le sort de vos données après votre décès.
							</li>
						</ul>
						<p>
				...
				>
					...
					<div className="text-base leading-relaxed space-y-3">
						...
						<ul className="list-disc list-inside space-y-2 text-univers/90">
							...
							<li>
								Authentification par jetons JWT dans des cookies httpOnly et
								sécurisés.
							</li>
							<li>
								Contrôle d&apos;accès par rôles (administrateur, apprenant,
								professionnel).
							</li>
				...
				>
					...
					<div className="text-base leading-relaxed space-y-3">
						<p>
							Certains de nos prestataires (Vercel, Google) sont basés aux
							États-Unis. Ces transferts sont encadrés par :
						</p>
						<ul className="list-disc list-inside space-y-2 text-univers/90">
							<li>
								Le Data Privacy Framework (DPF) UE-États-Unis pour les
								entreprises certifiées.
							</li>
							<li>
								Des clauses contractuelles types (CCT) approuvées par la
								Commission européenne.
							</li>
							<li>Des mesures complémentaires lorsque nécessaire.</li>
						</ul>
						<p>
							Le serveur applicatif et la base de données principale sont
							hébergés par OVHcloud en France.
						</p>
					</div>
				</section>
				...
				>
					...
					<div className="text-base leading-relaxed">
						<p>
							...
							refléter les évolutions légales, techniques ou opérationnelles. La
							date de dernière mise à jour en haut de page fait foi. Nous vous
				...
				>
					...
					<div className="text-base leading-relaxed space-y-2">
						...
						<ul className="list-none space-y-1 text-univers/90">
							...
							<li>
								Courrier : IPSEIS &mdash; 21 Rue de la Nation, 35400 Saint-Malo
							</li>
						</ul>
					</div>
				</section>
				...
				<div className="text-center pt-4">
					<Link
						...
						className="text-cohesion hover:underline underline-offset-4 font-medium"
					>
