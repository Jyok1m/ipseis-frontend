...
const evaluations: { term: string; definition: string }[] = [
	{
		...
		definition:
			"Évaluation réalisée en amont de la formation pour situer le niveau et les besoins des stagiaires et adapter le parcours.",
	},
	{
		term: "Évaluation formative (en cours de formation)",
		definition:
			"Évaluation continue tout au long de la formation permettant de mesurer la progression et de réajuster la pédagogie.",
	},
	{
		term: "Évaluation sommative (fin de formation)",
		definition:
			"Évaluation des acquis en fin de formation, au regard des objectifs pédagogiques.",
	},
	{
		term: "Évaluation de la satisfaction",
		definition:
			"Recueil de la satisfaction des stagiaires (et le cas échéant du commanditaire) à l'issue de la formation.",
	},
	{
		term: "Évaluation à froid",
		definition:
			"Évaluation réalisée quelques semaines/mois après la formation pour mesurer le transfert des acquis en situation professionnelle.",
	},
];
