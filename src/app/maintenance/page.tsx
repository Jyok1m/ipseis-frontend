...
export const metadata: Metadata = {
	...
	description:
		"Le site IPSEIS est momentanément en maintenance. Nous revenons très prochainement.",
	...
	return (
		<div className="bg-support min-h-full flex flex-col items-center justify-center px-6 py-16 text-center">
			<div className="flex max-w-xl flex-col items-center">
				...
				<h1 className="mb-5 text-3xl text-univers sm:text-4xl">
					Site en maintenance
				</h1>

				<p className="mb-8 text-base leading-relaxed text-univers/70 sm:text-lg">
					Nous réalisons actuellement une mise à jour complète de notre site
					afin de vous offrir une meilleure expérience. Il sera de nouveau
					accessible très prochainement. Merci de votre patience.
				</p>
