...
export const HealthValueSection = () => {
	return (
		<>
			<TitleSection
				tag="Nos valeurs"
				title="Des valeurs et des formateurs qui nous ressemblent et vous rassemblent"
			/>
					...
					<div className="relative grid grid-cols-1 gap-4 sm:gap-2 sm:[grid-template-columns:0.9fr_1fr_0.9fr] sm:[grid-template-rows:0.9fr_1fr_0.9fr] place-items-stretch">
						...
						<div className="sm:col-start-2 sm:row-start-1">
							<FeatureBox
								...
								description="Oser penser différemment pour former autrement"
								bgColor="maitrise"
								centered
							/>
						</div>
						...
						<div className="sm:col-start-3 sm:row-start-3 sm:-translate-x-16 md:-translate-x-32 lg:-translate-x-36">
							<FeatureBox
								...
								description="Faire de la confiance une évidence"
								bgColor="maitrise"
								centered
							/>
						</div>
